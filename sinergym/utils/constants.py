...
RANGES_5ZONE = {
    ...
    'day': [1.0, 31.0],
    'hour': [0.0, 23.0],
    'Site Outdoor Air Drybulb Temperature(Environment)': [-16.7, 32.7],
    'Site Outdoor Air Relative Humidity(Environment)': [13.0, 100.0],
    'Site Wind Speed(Environment)': [0.0, 23.1],
    'Site Wind Direction(Environment)': [0.0, 357.5],
    'Site Diffuse Solar Radiation Rate per Area(Environment)': [0.0, 604.0],
    'Site Direct Solar Radiation Rate per Area(Environment)': [0.0, 933.0],
    'Zone Thermostat Heating Setpoint Temperature(SPACE1-1)': [15.0, 22.0],
    'Zone Thermostat Cooling Setpoint Temperature(SPACE1-1)': [21.0, 30.0],
    'Zone Air Temperature(SPACE1-1)': [17.730728, 26.138037],
    'Zone Air Temperature(SPACE2-1)': [17.747627, 27.98096],
    'Zone Air Temperature(SPACE3-1)': [17.762114, 25.188044],
    'Zone Air Temperature(SPACE4-1)': [17.71661, 26.407755],
    'Zone Air Temperature(SPACE5-1)': [19.419329, 24.344854],
    'Zone Thermal Comfort Mean Radiant Temperature(SPACE1-1 PEOPLE 1)': [0.0,
                                                                        31.176582],
    'Zone Air Relative Humidity(SPACE1-1)': [8.631917, 79.8752],
    'Zone Thermal Comfort Clothing Value(SPACE1-1 PEOPLE 1)': [0.0, 1.0],
    'Zone Thermal Comfort Fanger Model PPD(SPACE1-1 PEOPLE 1)': [0.0, 79.65413],
    'Zone People Occupant Count(SPACE1-1)': [0.0, 11.0],
    'Zone People Occupant Count(SPACE2-1)': [0.0, 5.0],
    'Zone People Occupant Count(SPACE3-1)': [0.0, 11.0],
    'Zone People Occupant Count(SPACE4-1)': [0.0, 5.0],
    'Zone People Occupant Count(SPACE5-1)': [0.0, 20.0],
    'People Air Temperature(SPACE1-1 PEOPLE 1)': [0.0, 26.138037],
    'Facility Total HVAC Electricity Demand Rate(Whole Building)': [152.4869,
                                                                    30448.04],
    'Heating_Setpoint_RL': [15.0, 22.0],
    'Cooling_Setpoint_RL': [21.0, 30.0],
    'time (seconds)': [0, 31536000],
    'reward': [-12.572128257296006, -0.0015248689534142],
    'power_penalty': [-3.044803894609195, -0.0152486895341424],
    'comfort_penalty': [-2.6758175123052013, -0.0],
    'abs_comfort': [0.0, 15.9231526077579],
    'done': [True, False],
